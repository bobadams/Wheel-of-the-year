export const RING_DEFS = [
  ...
  { id: 'pm25',     label: 'Air Quality', unit: 'µg/m³', color: '#8e44ad', normLo: 0,   normHi: 35,  defaultNormMode: 'percentile', defaultVisible: false },
  { id: 'visibility', label: 'Visibility', unit: 'mi', color: '#5dade2', normLo: 2,   normHi: 10,  defaultNormMode: 'percentile', defaultVisible: false },
  { id: 'snow',     label: 'Snow Depth',  unit: 'in',  color: '#a8d8ea', normLo: 0,    normHi: 36,  defaultNormMode: 'minmax',    blankZero: true, defaultVisible: false },
  { id: 'cloud',    label: 'Cloud Cover', unit: '%',   color: '#95a5a6', normLo: 0,    normHi: 100, defaultNormMode: 'fixed',     defaultVisible: false },
];
