export const RING_DEFS = [
  { id: 'temp',     label: 'Temperature', unit: '°F',   color: '#c0392b', normLo: 20,   normHi: 100  },
  { id: 'rain',     label: 'Rainfall',    unit: 'in',   color: '#2471a3', normLo: 0,    normHi: 10   },
  { id: 'daylight', label: 'Daylight',    unit: 'hrs',  color: '#c8980a', normLo: 7,    normHi: 18   },
  { id: 'ndvi',     label: 'Vegetation',  unit: 'NDVI', color: '#27ae60', normLo: .03,  normHi: .80  },
  { id: 'wind',     label: 'Wind',        unit: 'mph',  color: '#7f8c8d', normLo: 3,    normHi: 16   },
];

export const RING_GAP   = 0.010;
export const RING_START = 0.075;
